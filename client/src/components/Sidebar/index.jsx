...
const navigation = [
    ...
    { end: false, name: 'Postes de tranformation', href: 'tstation', icon: HomeModernIcon, current: false},
    {end : false, name: 'Centrales Elèctriques', href: 'power', icon: HomeIcon, current: false},
